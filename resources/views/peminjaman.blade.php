...
<body class="h-screen bg-gray-100">
    ...
    <div id="modalAdd" class="fixed inset-0 z-50 hidden bg-black bg-opacity-50 flex justify-center items-center">
        <div class="modal-content bg-white rounded-lg shadow-lg p-6 w-1/3">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl text-center font-bold text-blue-400">Tambah Peminjaman</h2>
            ...
            <div class="modal-body mt-4">
                <form action="/peminjaman/create" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label for="nama_peminjam_add" class="block text-sm font-medium text-gray-700">Nama Peminjam</label>
                        <input type="text" name="nama_peminjam" id="nama_peminjam_add"
                    ...
                    <div class="mb-4">
                        <label for="book_id_add" class="block text-sm font-medium text-gray-700">Judul Buku</label>
                    ...
                    <div class="mb-4">
                        <label for="tanggal_peminjaman_add" class="block text-sm font-medium text-gray-700">Tanggal Peminjaman</label>
                        <input type="date" name="tanggal_peminjaman" id="tanggal_peminjaman_add"
                            class="mt-1 p-2 block w-full rounded-md border border-gray-300 shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            required>
                    </div>
                    <div class="mb-4">
                        <label for="tanggal_pengembalian_add" class="block text-sm font-medium text-gray-700">Tanggal Pengembalian</label>
    ...
    {{-- Modal Edit (Hanya Satu, Ditempatkan di Luar Loop) --}}
    <div id="modalEdit" class="fixed inset-0 z-50 hidden bg-black bg-opacity-50 flex justify-center items-center">
        <div class="modal-content bg-white rounded-lg shadow-lg p-6 w-1/3">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl text-center font-bold text-blue-400">Edit Peminjaman</h2>
            ...
            <div class="modal-body mt-4">
                <form id="editForm" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="nama_peminjam_edit" class="block text-sm font-medium text-gray-700">Nama Peminjam</label>
                    ...
                    <div class="mb-4">
                        <label for="tanggal_peminjaman_edit" class="block text-sm font-medium text-gray-700">Tanggal Peminjaman</label>
                        <input type="date" name="tanggal_peminjaman" id="tanggal_peminjaman_edit"
                            class="mt-1 p-2 block w-full rounded-md border border-gray-300 shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            required>
                    </div>
                    <div class="mb-4">
                        <label for="tanggal_pengembalian_edit" class="block text-sm font-medium text-gray-700">Tanggal Pengembalian</label>
